...
// Mock DEF course data
const DEF_COURSES = [
  {
    id: 'def-math',
    title: 'Mathématiques',
    description: 'Intégrales, dérivées et fonctions',
    lessonsCount: 18,
    progress: 0.3,
    color: '#3B82F6',
  ...
  },
  {
    id: 'def-physics',
    title: 'Physique',
    description: 'Forces, mécanique et électricité',
    lessonsCount: 16,
    progress: 0,
    color: '#EC4899',
    icon: 'flask-outline',
  },
  {
    id: 'def-literature',
    title: 'Littérature',
    description: 'Résumé et analyse de textes',
    lessonsCount: 14,
    progress: 0,
    color: '#F59E0B',
    icon: 'book-outline',
        ...
        <View style={styles.headerSection}>
          ...
          <View style={styles.filterRow}>
            <TouchableOpacity style={[styles.filterButton, { backgroundColor: theme.primary }]}>              
              <Text style={styles.filterActive}>Tous</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.filterButton, { backgroundColor: theme.cardBackground }]}>              
              <Text style={[styles.filterText, { color: theme.textSecondary }]}>En cours</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.filterButton, { backgroundColor: theme.cardBackground }]}>              
              <Text style={[styles.filterText, { color: theme.textSecondary }]}>Terminés</Text>
            </TouchableOpacity>
          </View>
        </View>
          ...
          >
            <View
              style={[
                ...
                { width: '42%', backgroundColor: theme.primary },
              ]}
            />
          </View>
          <Text style={[styles.overallText, { color: theme.textSecondary }]}>42% du programme complété</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  filterActive: { fontSize: 14, fontWeight: '500', color: '#FFF' },
